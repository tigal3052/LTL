...
- `app-LTL/resources/UI/codex/v5/codex_v5_scroll_relic_token.png`
  - codex v5 scroll relic token is a UI art resource or Godot import metadata file.
- `app-LTL/resources/UI/codex/v5/codex_v5_scroll_relic_token.png.import`
  - codex v5 scroll relic token.png is a UI art resource or Godot import metadata file.
...
- `LTL-harness/new_design/ltl_clear_redesign/assets/bg_parchment_1440x900.png`
  - bg parchment 1440x900 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_clear_redesign/assets/hero_leviathan_band.png`
  - hero leviathan band provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_clear_redesign/assets/panel_parchment.png`
  - panel parchment provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_clear_redesign/assets/radiance_glow_aqua.png`
  - radiance glow aqua provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_clear_redesign/assets/radiance_glow_green.png`
  - radiance glow green provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_clear_redesign/assets/stamp_investigation_complete.png`
  - stamp investigation complete provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_clear_redesign/EVAL_LOG.md`
  - EVAL LOG provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_clear_redesign/index.html`
  - index provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_clear_redesign/README.md`
  - README provides an LTL harness entrypoint or agent rule set.
...
- `LTL-harness/new_design/ltl_fail_redesign/APPLY_EVAL_LOG.md`
  - APPLY EVAL LOG provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/APPLY_PLAN.md`
  - APPLY PLAN provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/alpha_bounds.json`
  - alpha bounds provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/board_pin.png`
  - board pin provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/dark_forest_bg.png`
  - dark forest bg provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/defeat_photo.png`
  - defeat photo provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/icon_halted.png`
  - icon halted provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/lantern.png`
  - lantern provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/polaroid_frame.meta.txt`
  - polaroid frame.meta provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/polaroid_frame.png`
  - polaroid frame provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/spore_dust.png`
  - spore dust provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/toast_portrait.png`
  - toast portrait provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/assets/toast_visual.png`
  - toast visual provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/EVAL_LOG.md`
  - EVAL LOG provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/index.html`
  - index provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_fail_redesign/README.md`
  - README provides an LTL harness entrypoint or agent rule set.
...
- `LTL-harness/new_design/ltl_reward_redesign/assets/backpack_board_runtime.png`
  - backpack board runtime provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/bg_parchment_screen.png`
  - bg parchment screen provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/boss_relic_circle.png`
  - boss relic circle provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/btn_primary.png`
  - btn primary provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/btn_secondary.png`
  - btn secondary provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/card_normal.png`
  - card normal provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/card_selected.png`
  - card selected provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/chip_active.png`
  - chip active provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/chip_inactive.png`
  - chip inactive provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/chip_ruin_tablet.png`
  - chip ruin tablet provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/desk_frame_wood.png`
  - desk frame wood provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/icon_boss_crest.png`
  - icon boss crest provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/icon_reward_geode.png`
  - icon reward geode provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/ledger_panel.png`
  - ledger panel provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/panel_parchment.png`
  - panel parchment provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/release_zone_bg.png`
  - release zone bg provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/seal_sanctum.png`
  - seal sanctum provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/assets/thumb_slot.png`
  - thumb slot provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/boss.html`
  - boss provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_reward_redesign/generate_assets.py`
...
- `LTL-harness/new_design/ltl_settings_redesign/assets/bg_current_settings_1440x900.png`
  - bg current settings 1440x900 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/assets/bg_node_select_1440x900.png`
  - bg node select 1440x900 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/assets/dropdown_pill.png`
  - dropdown pill provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/assets/folio_card_9slice.png`
  - folio card 9slice provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/assets/icon_leaf_sprig.png`
  - icon leaf sprig provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/assets/panel_parchment.png`
  - panel parchment provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/assets/slider_thumb.png`
  - slider thumb provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/assets/stitch_dropdown_pill.png`
  - stitch dropdown pill provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/assets/toggle_off.png`
  - toggle off provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/assets/toggle_on.png`
  - toggle on provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/EVAL_LOG.md`
  - EVAL LOG provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_settings_redesign/index.html`
  - index provides an LTL harness entrypoint or agent rule set.
...
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_catalog_panel_380x560.png`
  - shop catalog panel 380x560 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_cta_ghost_100x24.png`
  - shop cta ghost 100x24 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_cta_hero_120x28.png`
  - shop cta hero 120x28 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_cta_limestone_120x28.png`
  - shop cta limestone 120x28 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_detail_panel_560x740.png`
  - shop detail panel 560x740 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_dim_backdrop_1440x900.png`
  - shop dim backdrop 1440x900 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_hero_fallback_280x210.png`
  - shop hero fallback 280x210 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_hero_seed_280x280.png`
  - shop hero seed 280x280 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_icon_gold_24.png`
  - shop icon gold 24 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_icon_xp_24.png`
  - shop icon xp 24 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_item_card_normal_320x76.png`
  - shop item card normal 320x76 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_item_card_owned_320x76.png`
  - shop item card owned 320x76 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_item_card_selected_320x76.png`
  - shop item card selected 320x76 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_leaf_watermark_150.png`
  - shop leaf watermark 150 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_overlay_card_640x800.png`
  - shop overlay card 640x800 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_price_badge_gold_80x20.png`
  - shop price badge gold 80x20 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_price_badge_xp_80x20.png`
  - shop price badge xp 80x20 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_sold_seal_48.png`
  - shop sold seal 48 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_tab_active_120x28.png`
  - shop tab active 120x28 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/assets/shop_tab_inactive_120x28.png`
  - shop tab inactive 120x28 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/EVAL_LOG.md`
  - EVAL LOG provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/gen_assets.py`
  - gen assets provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/index.html`
  - index provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_shop_redesign/README.md`
  - README provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/APPLY_EVAL_LOG.md`
  - APPLY EVAL LOG provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/APPLY_PLAN.md`
  - APPLY PLAN provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/accent_bar_aqua_6x84.png`
  - accent bar aqua 6x84 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/accent_bar_leaf_6x84.png`
  - accent bar leaf 6x84 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/accent_bar_primary_6x108.png`
  - accent bar primary 6x108 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/badge_leaf_72.png`
  - badge leaf 72 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/badge_map_96.png`
  - badge map 96 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/badge_speaker_72.png`
  - badge speaker 72 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/badge_trace_72.png`
  - badge trace 72 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/badge_warn_96.png`
  - badge warn 96 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/bg_context_1440x900.jpg`
  - bg context 1440x900 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/coffee_stain_150.png`
  - coffee stain 150 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/coffee_stain_240.png`
  - coffee stain 240 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/confirm_card_576x352.png`
  - confirm card 576x352 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/confirm_message_panel_300x132.png`
  - confirm message panel 300x132 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/cta_hero_176x48.png`
  - cta hero 176x48 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/cta_limestone_176x48.png`
  - cta limestone 176x48 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/radiance_leaf_240x88.png`
  - radiance leaf 240x88 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/stitch_vista_band_1440x372.jpg`
  - stitch vista band 1440x372 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/toast_card_info_372x84.png`
  - toast card info 372x84 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/assets/toast_card_narrative_436x112.png`
  - toast card narrative 436x112 provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/EVAL_LOG.md`
  - EVAL LOG provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/gen_assets.py`
  - gen assets provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/index.html`
  - index provides an LTL harness entrypoint or agent rule set.
- `LTL-harness/new_design/ltl_toast_redesign/README.md`
  - README provides an LTL harness entrypoint or agent rule set.
