...
const DEFAULT_TUNING := {"combat": {"matchDamage": 2, "normalDamage": 1, "mismatchDamage": 0}, "queue": {"capacity": 16, "repairThreshold": 3}, "stageScaling": {"stageDurabilityTotals": [44.0, 72.0, 108.0, 150.0, 196.0], "stageHealthTotals": [24.0, 42.0, 64.0, 92.0, 124.0], "baseTimeLimitTicks": 1800}, "reward": {"weaknessBonus": 2}}
