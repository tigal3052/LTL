...
func test_tooltip_projects_reward_dictionary() -> void:
	...
	_assert(str(model["bbcode"]).contains("비콘 충전 효과"), "tooltip bbcode includes beacon effects")
...
func test_reward_drill_tooltip_compares_same_color_equipped_drill() -> void:
	...
	var reward = {"kind": "보상 루비 드릴", "rarity": "rare", "payload": {"item_type": "drill", "energy_type": "red", "base_cooldown_ticks": 70, "damage": 1.8}, "presentation": {"description": "빨간색 보상 드릴"}}
